...
void testIndex() {
  ...
  //hunter_0602_black //98
   ...
   //String index = "strokes_000000584_hunter_0601"; //207
   ...
   double sampleXPercentage = 0.4;
   double sampleYPercentage = 0.6;
   JSONObject closestStroke = getStrokeAtPercent(destIndex, sampleXPercentage, sampleYPercentage); 
   System.out.println(closestStroke.toString());
   */
