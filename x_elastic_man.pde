...
void markElasticonAccessPoints() {
  ...
  for (int i=0; i<accesspoints.size();i++) {
    ...
    goToStartPose();
    smoothStrokeElastic(lonPercentage, latPercentage, lonPercentage, latPercentage, threeBrushVec56, 0, false, true, false);
    smoothStrokeElastic(lonPercentage, latPercentage, lonPercentage, latPercentage, threeBrushVec56, 0, true, false, false);
    smoothStrokeElastic(lonPercentage, latPercentage, lonPercentage, latPercentage, threeBrushVec56, 0, false, false, true);  
  } 
}
